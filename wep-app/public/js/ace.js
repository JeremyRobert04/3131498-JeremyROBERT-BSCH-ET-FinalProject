(function () {
  ...
  ace.define(
    "ace/lib/lang",
    ["require", "exports", "module", "ace/lib/deep_copy"],
    function (e, t, n) {
      "use strict";
      (t.last = function (e) {
        return e[e.length - 1];
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      (t.isWin = i == "win"),
        ...
        (t.isSafari =
          (parseFloat(s.split(" Safari/")[1]) && !t.isChrome) || undefined),
  ...
  ace.define(
    ...
    function (e, t, n) {
      t.reportError = function (t, n) {
        var r = new Error(t);
        (r.data = n),
          typeof console == "object" && console.error && console.error(r),
          setTimeout(function () {
            throw r;
          });
      };
    ...
    function (e, t, n) {
      var r = {
        ...
        "gutter.annotation.aria-label.warning":
          "Warning, read annotations row $0",
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("./oop"),
        ...
        s = e("./report_error").reportError,
        o = e("./default_english_messages").defaultEnglishMessages,
        u = {
      ...
      (l.prototype.warn = a),
        (l.prototype.reportError = s),
        r.implement(l.prototype, i),
        (t.AppConfig = l);
    }
  ),
  ace.define(
        ...
        (t.loadModule = function (e, n) {
          ...
          var u = function (e) {
            ...
            var r = function () {
              a(o, function (e, n) {
                n && (t.$loaded[o] = n),
                  t._emit("load.module", { name: o, module: n });
                var r = t.$loading[o];
                (t.$loading[o] = null),
          ...
          if (t.dynamicModules[o])
            t.dynamicModules[o]().then(function (e) {
          ...
          (this.setAriaOptions = function (e) {
            ...
            if (e.setLabel) {
              n.setAttribute(
                ...
                i("text-input.aria-roledescription", "editor")
              );
              if (t.session) {
                var r = t.session.selection.cursor.row;
                n.setAttribute(
                  "aria-label",
                  i("text-input.aria-label", "Cursor at row $0", [r + 1])
                );
              }
            }
          }),
          ...
          (this.focus = function () {
            ...
            if (r) {
              ...
              while (o && o.nodeType == 1)
                s.push(o),
                  o.setAttribute("ace_nocontext", "true"),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r =
        ...
        o = e("./lib/event"),
        u = e("./range").Range,
        a = e("./lib/scroll").preventParentScroll,
        f = "ace_tooltip",
        l = (function () {
          function e(e) {
          ...
          return (
            ...
            (e.prototype.setTheme = function (e) {
              this.$element.className =
                f + " " + (e.isDark ? "ace_dark " : "") + (e.cssClass || "");
            }),
        ...
        return (
          ...
          (t.prototype.showForRange = function (e, t, n, r) {
            ...
            this.isOpen ||
              ...
              (this.range = u.fromPoints(t.start, t.end));
            var o = s.textToScreenCoordinates(t.start.row, t.start.column),
              a = s.scroller.getBoundingClientRect();
            ...
            var l = f.clientHeight,
              c = f.clientWidth,
              p = window.innerHeight - o.pageY - s.lineHeight,
              d = !0;
            o.pageY - l < 0 && o.pageY < p && (d = !1),
              (f.style.maxHeight = (d ? o.pageY : p) - i + "px"),
              (f.style.top = d ? "" : o.pageY + s.lineHeight + "px"),
              (f.style.bottom = d ? window.innerHeight - o.pageY + "px" : ""),
              (f.style.left =
                Math.min(o.pageX, window.innerWidth - c - i) + "px");
          }),
          ...
          (t.prototype.$registerCloseEvents = function () {
            window.addEventListener("keydown", this.hide, !0),
              window.addEventListener("wheel", this.hide, !0),
          ...
          (t.prototype.$removeCloseEvents = function () {
            window.removeEventListener("keydown", this.hide, !0),
              window.removeEventListener("wheel", this.hide, !0),
          ...
          Object.defineProperty(t, "annotationLabels", {
            get: function () {
              return {
                error: {
                  singular: a(
                    "gutter-tooltip.aria-label.error.singular",
                    "error"
                  ),
                ...
                warning: {
                  singular: a(
                    "gutter-tooltip.aria-label.warning.singular",
                    "warning"
                  ),
                  plural: a(
                    "gutter-tooltip.aria-label.warning.plural",
                    "warnings"
                  ),
                },
                info: {
                  singular: a(
                    "gutter-tooltip.aria-label.info.singular",
                    "information message"
                  ),
                  plural: a(
                    "gutter-tooltip.aria-label.info.plural",
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      (u.prototype.setSelectionAnchor = u.prototype.setAnchor),
        (u.prototype.getSelectionAnchor = u.prototype.getAnchor),
        (u.prototype.setSelectionRange = u.prototype.setRange),
        r.implement(u.prototype, s),
        (t.Selection = u);
    }
  ),
  ace.define(
    "ace/tokenizer",
    ["require", "exports", "module", "ace/lib/report_error"],
    function (e, t, n) {
      "use strict";
      var r = e("./lib/report_error").reportError,
        i = 2e3,
        s = (function () {
          function e(e) {
            this.splitRegex,
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../lib/deep_copy").deepCopy,
        i;
      (i = function () {
        this.$rules = {
          start: [
    ...
    function (e, t, n) {
      ...
      (d = function (e) {
        (e = e || {}),
          this.add("braces", "insertion", function (t, n, r, i, s) {
            ...
            if (s == "{") {
              ...
              var l = r.getSelectionRange(),
                ...
                v = i.getTokenAt(u.row, u.column);
              if (c !== "" && c !== "{" && r.getWrapBehavioursEnabled())
                return p(l, c, "{", "}");
              if (v && /(?:string)\.quasi|\.xml/.test(v.type)) {
                var m = [/tag\-(?:open|name)/, /attribute\-name/];
                if (
                  m.some(function (e) {
                    return e.test(v.type);
                  }) ||
                  (/(string)\.quasi/.test(v.type) &&
                    v.value[u.column - v.start - 1] !== "$")
                )
                  return;
                return (
              ...
              if (g == "}") {
                ...
                if (y !== null && d.isAutoInsertedClosing(u, a, s))
                  return (
              ...
              if (s == "\n" || s == "\r\n") {
                ...
                d.isMaybeInsertedClosing(u, a) &&
                  ((b = o.stringRepeat("}", f.maybeInsertedBrackets)),
                ...
                return {
                  text: "\n" + S + "\n" + E + b,
                  selection: [1, S.length, 1, S.length],
                };
              }
              d.clearMaybeInsertedClosing();
            }
          ...
          e.closeDocComment !== !1 &&
            this.add("doc comment end", "insertion", function (e, t, n, r, i) {
              if (
                e === "doc-start" &&
                (i === "\n" || i === "\r\n") &&
                n.selection.isEmpty()
              ...
              if (typeof r != "string") {
                if (Array.isArray(r[2])) {
                  var i = r[2][r[2].length - 1],
                    s = this.$modes[i];
                  if (s)
                    return s[e].apply(s, [r[1]].concat([].slice.call(t, 1)));
                }
                r = r[0] || "start";
              }
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        v = (function () {
          ...
          return (
            ...
            (e.fromJSON = function (t) {
              ...
              var n = new d();
              (n.$undoStack = t.history.undo),
                (n.$redoStack = t.history.redo),
                (n.mark = t.history.mark),
                (n.$rev = t.history.rev);
              var r = new e(t.value);
              return (
                t.folds.forEach(function (e) {
                  r.addFold("...", l.fromPoints(e.start, e.end));
                }),
                r.setAnnotations(t.annotations),
                r.setBreakpoints(t.breakpoints),
                r.setMode(t.mode),
                r.setScrollLeft(t.scrollLeft),
                r.setScrollTop(t.scrollTop),
                r.setUndoManager(n),
                r.selection.fromJSON(t.selection),
                r
              );
            }),
            (e.prototype.toJSON = function () {
                        ...
                        function (e, t, r, i) {
                          ...
                          if (e != null) {
                            (s = this.$getDisplayTokens(e, o.length)),
                              (s[0] = y);
                            for (var u = 1; u < s.length; u++) s[u] = b;
                          } else
            ...
            (e.prototype.$computeWrapSplits = function (e, t, n) {
              ...
              while (i - s > t - h) {
                ...
                if (e[p] == y || e[p] == b) {
                  for (p; p != s - 1; p--) if (e[p] == y) break;
                  if (p > s) {
                    c(p);
                    continue;
                  }
                  p = s + t;
                  for (p; p < e.length; p++) if (e[p] != b) break;
                  if (p == e.length) break;
                  c(p);
                  continue;
                }
            ...
            (e.prototype.$getDisplayTokens = function (e, t) {
              ...
              for (var i = 0; i < e.length; i++) {
                ...
                if (s == 9) {
                  (r = this.getScreenTabSize(n.length + t)), n.push(S);
                  for (var o = 1; o < r; o++) n.push(x);
                } else
                  s == 32
                    ? n.push(E)
                    : (s > 39 && s < 48) || (s > 57 && s < 64)
            ...
            (e.prototype.getPrecedingCharacter = function () {
              ...
              if (e.column === 0)
                return e.row === 0 ? "" : this.doc.getNewLineCharacter();
              var t = this.getLine(e.row);
              return t[e.column - 1];
            }),
            (e.prototype.destroy = function () {
      ...
      (v.$uid = 0),
        (v.prototype.$modes = o.$modes),
        (v.prototype.getValue = v.prototype.toString),
        (v.prototype.$defaultUndoManager = {
          undo: function () {},
          redo: function () {},
          hasUndo: function () {},
          hasRedo: function () {},
        ...
        (v.prototype.$overwrite = !1),
        (v.prototype.$mode = null),
        (v.prototype.$modeId = null),
        (v.prototype.$scrollTop = 0),
        (v.prototype.$scrollLeft = 0),
        (v.prototype.$wrapLimit = 80),
        (v.prototype.$useWrapMode = !1),
        (v.prototype.$wrapLimitRange = { min: null, max: null }),
        (v.prototype.lineWidgets = null),
        (v.prototype.isFullWidth = T),
        r.implement(v.prototype, u);
      var m = 1,
        g = 2,
        y = 3,
        b = 4,
        ...
        S = 11,
        x = 12;
      e("./edit_session/folding").Folding.call(v.prototype),
        e("./edit_session/bracket_match").BracketMatch.call(v.prototype),
        o.defineOptions(v.prototype, "session", {
          wrap: {
            set: function (e) {
              !e || e == "off"
                ? (e = !1)
        ...
        o = (function () {
          ...
          return (
            ...
            (e.prototype.replace = function (e, t) {
              ...
              n.regExp || (t = t.replace(/\$/g, "$$$$")), (t = e.replace(r, t));
              if (n.preserveCase) {
                t = t.split("");
            ...
            (e.prototype.$matchIterator = function (e, t) {
              ...
              var i = t.backwards == 1,
                ...
                u = t.range,
                a = t.start;
              a || (a = u ? u[i ? "end" : "start"] : e.selection.getRange()),
                a.start && (a = a[s != i ? "end" : "start"]);
              var f = u ? u.start.row : 0,
                l = u ? u.end.row : e.getLength() - 1;
              if (i)
                var c = function (e) {
                  var n = a.row;
                  if (p(n, a.column, e)) return;
                  for (n--; n >= f; n--) if (p(n, Number.MAX_VALUE, e)) return;
                  if (t.wrap == 0) return;
                  for (n = l, f = a.row; n >= f; n--)
                    if (p(n, Number.MAX_VALUE, e)) return;
                };
              else
                var c = function (e) {
                  var n = a.row;
                  if (p(n, a.column, e)) return;
                  for (n += 1; n <= l; n++) if (p(n, 0, e)) return;
                  if (t.wrap == 0) return;
                  for (n = f, l = a.row; n <= l; n++) if (p(n, 0, e)) return;
                };
              if (t.$isMultiLine)
                var h = n.length,
                  p = function (t, r, s) {
                    var o = i ? t - h + 1 : t;
                    if (o < 0 || o + h > e.getLength()) return;
                    var u = e.getLine(o),
                      a = u.search(n[0]);
                    if ((!i && a < r) || a === -1) return;
                    for (var f = 1; f < h; f++) {
                ...
                var p = function (t, i, s) {
                  ...
                  while ((f = n.exec(u))) {
                    ...
                    if (!c) {
                      if (l >= u.length) break;
                      n.lastIndex = l += r.skipEmptyMatch(u, l, o);
                    }
                    if (f.index + c > i) break;
                    a.push(f.index, c);
                  }
                  for (var h = a.length - 1; h >= 0; h -= 2) {
                    var p = a[h - 1],
                      c = a[h];
                    if (s(t, p, t, p + c)) return !0;
                  }
                };
              else
                var p = function (t, i, s) {
                  ...
                  while ((f = n.exec(u))) {
                    var l = f[0].length;
                    a = f.index;
                    if (s(t, a, t, a + l)) return !0;
                    if (!l) {
                      n.lastIndex = a += r.skipEmptyMatch(u, a, o);
              ...
              for (var u = 0; u < n.length; u++) {
                ...
                for (var l = a; l <= f; l++) {
                  ...
                  if (s !== h) {
                    ...
                    s.length > 0 && e.insert({ row: l, column: 0 }, s);
                  }
                  t.autoOutdent(r, e, l);
                }
              }
              ...
              e
                ? ((this.renderer.enableKeyboardAccessibility = !0),
                  ...
                  this.renderer.scroller.setAttribute(
                    "aria-roledescription",
                    S("editor.scroller.aria-roledescription", "editor")
                  ),
                  ...
                  this.renderer.$gutter.setAttribute(
                    "aria-roledescription",
                    S("editor.gutter.aria-roledescription", "editor")
                  ),
                  this.renderer.$gutter.setAttribute(
                    "aria-label",
                    S(
        ...
        f = (function () {
          ...
          return (
            ...
            (e.prototype.$renderCell = function (e, t, n, i) {
                ...
                L
                  ...
                  T
                    ? (f.setAttribute("aria-expanded", "false"),
                      f.setAttribute(
                        "title",
                        a("gutter.code-folding.closed.title", "Unfold code")
                      ))
                    : (f.setAttribute("aria-expanded", "true"),
                      f.setAttribute(
                        "title",
                        a("gutter.code-folding.open.title", "Fold code")
                      ));
              } else
                f &&
              ...
              if (C && this.$showFoldedAnnotations) {
  ...
  ace.define(
    ...
    ["require", "exports", "module"],
    function (e, t, n) {
      var r = new Set(["text", "rparen", "lparen"]);
  ...
  ace.define(
    ...
    function (e, t, n) {
            ...
            (e.prototype.$renderToken = function (e, t, n, r) {
              ...
              while ((l = o.exec(r))) {
                ...
                (c = l.index + l[0].length),
                  g && u.appendChild(this.dom.createTextNode(g, this.element));
                if (h) {
                  ...
                  if (i.showSpaces) {
                    ...
                    (b.className = "ace_invisible ace_invisible_space"),
                      (b.textContent = s.stringRepeat(i.SPACE_CHAR, p.length)),
                      u.appendChild(b);
                  } else
                    u.appendChild(this.dom.createTextNode(p, this.element));
                else if (d) {
                  var b = this.dom.createElement("span");
                  (b.className =
                    "ace_invisible ace_invisible_space ace_invalid"),
                    (b.textContent = s.stringRepeat(i.SPACE_CHAR, d.length)),
                    u.appendChild(b);
                } else if (v) {
                  t += 1;
                  var b = this.dom.createElement("span");
                  (b.style.width = i.config.characterWidth * 2 + "px"),
                    (b.className = i.showSpaces
                      ? "ace_cjk ace_invisible ace_invisible_space"
                      : "ace_cjk"),
                    (b.textContent = i.showSpaces ? i.SPACE_CHAR : v),
                    u.appendChild(b);
                } else if (m) {
                  t += 1;
                  var b = this.dom.createElement("span");
              ...
              u.appendChild(
                this.dom.createTextNode(c ? r.slice(c) : r, this.element)
              );
              if (!f(n.type)) {
                var w = "ace_" + n.type.replace(/\./g, " ace_"),
                  b = this.dom.createElement("span");
                n.type == "fold" &&
                  ((b.style.width =
                    n.value.length * this.config.characterWidth + "px"),
                  b.setAttribute(
                    "title",
                    a("inline-fold.closed.title", "Unfold code")
                  )),
                  (b.className = w),
                  b.appendChild(u),
                  e.appendChild(b);
      ...
      (l.prototype.EOF_CHAR = "\u00b6"),
        (l.prototype.EOL_CHAR_LF = "\u00ac"),
        (l.prototype.EOL_CHAR_CRLF = "\u00a4"),
        (l.prototype.EOL_CHAR = l.prototype.EOL_CHAR_LF),
        (l.prototype.TAB_CHAR = "\u2014"),
        (l.prototype.SPACE_CHAR = "\u00b7"),
        (l.prototype.$padding = 0),
        (l.prototype.MAX_LINE_LENGTH = 1e4),
        (l.prototype.showInvisibles = !1),
        (l.prototype.showSpaces = !1),
        (l.prototype.showTabs = !1),
        (l.prototype.showEOL = !1),
        (l.prototype.displayIndentGuides = !0),
        (l.prototype.$highlightIndentGuides = !0),
        (l.prototype.$tabStrings = []),
        (l.prototype.destroy = {}),
        (l.prototype.onChangeTabSize = l.prototype.$computeTabString),
        r.implement(l.prototype, u),
        (t.Text = l);
    }
  ),
  ace.define(
        ...
        return (
          ...
          (e.prototype.setGhostText = function (e, t) {
            ...
            if (i.length > 1) {
              ...
              var s = this.$cursorLayer.getPixelPosition(r, !0),
                o = this.container,
                u = o.getBoundingClientRect().height,
                a = i.length * this.lineHeight,
                f = a < u - s.top;
              if (f) return;
              a < u
                ? this.scrollBy(0, (i.length - 1) * this.lineHeight)
                : this.scrollToRow(r.row);
            }
          }),
          (e.prototype.removeGhostText = function () {
    ...
    function (e, t, n) {
      ...
      (t.showErrorMarker = function (e, t) {
        ...
        if (l) {
          ...
          if (f) return;
          c = {
            text: [o("error-marker.good-state", "Looks good!")],
            className: "ace_ok",
          };
        }
