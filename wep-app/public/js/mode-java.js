ace.define(
        ...
        u = function () {
          this.add("string_dquotes", "insertion", function (e, t, n, r, i) {
            if (i == '"' || i == "'") {
              ...
              var d = !c || c.match(/\s/);
              if (
                (o(p, "attribute-equals") && (d || c == ">")) ||
                (o(p, "decl-attribute-equals") && (d || c == "?"))
              )
            ...
            this.add("autoclosing", "insertion", function (e, t, n, r, i) {
              if (i == ">") {
                var u = n.getSelectionRange().start,
                ...
                if (o(f, "attribute-value")) {
                  ...
                  if (u.column < l) return;
                  if (u.column == l) {
                    var c = a.stepForward();
                    if (c && o(c, "attribute-value")) return;
                    a.stepBackward();
                  }
                }
                if (/^\s*>/.test(r.getLine(u.row).slice(u.column))) return;
                while (!o(f, "tag-name")) {
                  f = a.stepBackward();
                  if (f.value == "<") {
                    f = a.stepForward();
                ...
                var d = f.value;
                h == u.row && (d = d.substring(0, u.column - p));
                if (
                  this.voidElements &&
            ...
            this.add("autoindent", "insertion", function (e, t, n, r, i) {
              if (i == "\n") {
                var u = n.getCursorPosition(),
                  a = r.getLine(u.row),
                  f = new s(r, u.row, u.column),
                  l = f.getCurrentToken();
                if (o(l, "") && l.type.indexOf("tag-close") !== -1) {
                  if (l.value == "/>") return;
                  while (l && l.type.indexOf("tag-name") === -1)
                    l = f.stepBackward();
                  if (!l) return;
                  var c = l.value,
                    h = f.getCurrentTokenRow();
                  l = f.stepBackward();
                  if (!l || l.type.indexOf("end-tag") !== -1) return;
                  if (
                    (this.voidElements && !this.voidElements[c]) ||
                    !this.voidElements
                  ) {
                    var p = r.getTokenAt(u.row, u.column + 1),
                      a = r.getLine(h),
                      d = this.$getIndent(a),
                      v = d + r.getTabString();
                    return p && p.value === "</"
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../../lib/oop"),
        i = e("../../token_iterator").TokenIterator,
        s = e("../behaviour/cstyle").CstyleBehaviour,
        o = e("../behaviour/xml").XmlBehaviour,
        u = function () {
          var e = new o({ closeCurlyBraces: !0 }).getBehaviours();
          this.addBehaviours(e),
            this.inherit(s),
            this.add(
              "autoclosing-fragment",
              "insertion",
              function (e, t, n, r, s) {
                if (s == ">") {
                  var o = n.getSelectionRange().start,
                    u = new i(r, o.row, o.column),
                    a = u.getCurrentToken() || u.stepBackward();
                  if (!a) return;
                  if (a.value == "<")
                    return { text: "></>", selection: [1, 1] };
                }
      ...
      r.inherits(u, s), (t.JavaScriptBehaviour = u);
    }
  ),
  ace.define(
        ...
        function () {
          (this.getFoldWidgetRangeBase = this.getFoldWidgetRange),
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              return r ? r : this.xmlFoldMode.getFoldWidget(e, t, n);
            }),
            (this.getFoldWidgetRange = function (e, t, n, r) {
              var i = this.getFoldWidgetRangeBase(e, t, n, r);
              return i ? i : this.xmlFoldMode.getFoldWidgetRange(e, t, n);
            });
        }.call(o.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        f = e("./folding/javascript").FoldMode,
        l = function () {
        ...
        o = function () {
          ...
          (this.$rules = {
            ...
            statements: [
              ...
              { token: "keyword", regex: "(?:" + t + ")\\b" },
              { token: "storage.type.annotation", regex: "@" + e + "\\b" },
              { token: "entity.name.function", regex: e + "(?=\\()" },
              { token: s, regex: e + "\\b" },
              {
                token: "keyword.operator",
                regex:
